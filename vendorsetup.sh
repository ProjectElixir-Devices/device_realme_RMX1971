...
# CommonTree
rm -rf device/realme/sdm710-common && git clone https://github.com/ProjectElixir-Devices/device_realme_sdm710-common -b 13 device/realme/sdm710-common

echo 'Cloning Kernel tree'
# Kernel Tree
rm -rf kernel/realme/sdm710 && git clone --depth=1 https://github.com/AnilShebin/kernel_realme_RMX1971 -b 13 kernel/realme/sdm710
...
# Vendor Common Tree
rm -rf vendor/realme/sdm710-common && git clone https://github.com/ProjectElixir-Devices/vendor_realme_sdm710-common -b tiramisu vendor/realme/sdm710-common
